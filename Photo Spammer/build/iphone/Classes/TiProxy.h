...
//Rare exceptions to indicate a bug in the _photospammer code (Eg, function that a subclass should have implemented)
...
/**
 The base class for PhotoSpammer proxies.
 */
