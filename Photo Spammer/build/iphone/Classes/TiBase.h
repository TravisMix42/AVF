...
// in simulator we redefine to format for PhotoSpammer Developer console
...
{\
	NSString * exceptionName = [@"org.photospammer." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.photospammer";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPhotoSpammerNativeItemNone = -1, 
	UIPhotoSpammerNativeItemSpinner = -2,
	UIPhotoSpammerNativeItemProgressBar = -3,
	
	UIPhotoSpammerNativeItemSlider = -4,
	UIPhotoSpammerNativeItemSwitch = -5,
	UIPhotoSpammerNativeItemMultiButton = -6,
	UIPhotoSpammerNativeItemSegmented = -7,
	
	UIPhotoSpammerNativeItemTextView = -8,
	UIPhotoSpammerNativeItemTextField = -9,
	UIPhotoSpammerNativeItemSearchBar = -10,
	
	UIPhotoSpammerNativeItemPicker = -11,
	UIPhotoSpammerNativeItemDatePicker = -12,
	
	UIPhotoSpammerNativeItemInfoLight = -13,
	UIPhotoSpammerNativeItemInfoDark = -14,
	
	UIPhotoSpammerNativeItemDisclosure = -15,
	
	UIPhotoSpammerNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all PhotoSpammer instances of
