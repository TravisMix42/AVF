...
//@interface PhotoSpammerObject : NSObject
//@end

@interface PhotoSpammerObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PhotoSpammerObject class]])
		{
			for (NSString *key in [[(PhotoSpammerObject*)o modules] allKeys])
			{
