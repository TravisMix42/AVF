...
/**
 Base class for all PhotoSpammer views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the PhotoSpammer view hierarchy (such as wrapped iOS UIViews) was touched.
