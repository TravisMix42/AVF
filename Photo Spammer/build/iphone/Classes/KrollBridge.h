...
@interface PhotoSpammerObject : KrollCoverageObject {
#else
@interface PhotoSpammerObject : KrollObject {
#endif
@private
...
extern NSString * PhotoSpammer$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PhotoSpammerObject *_photospammer;
    KrollObject* console;
	BOOL shutdown;
