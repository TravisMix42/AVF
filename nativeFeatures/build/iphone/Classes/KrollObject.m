...
//@interface nativeFeaturesObject : NSObject
//@end

@interface nativeFeaturesObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[nativeFeaturesObject class]])
		{
			for (NSString *key in [[(nativeFeaturesObject*)o modules] allKeys])
			{
