...
//Rare exceptions to indicate a bug in the _nativefeatures code (Eg, function that a subclass should have implemented)
...
/**
 The base class for nativeFeatures proxies.
 */
