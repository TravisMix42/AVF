...
@interface nativeFeaturesObject : KrollCoverageObject {
#else
@interface nativeFeaturesObject : KrollObject {
#endif
@private
...
extern NSString * nativeFeatures$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	nativeFeaturesObject *_nativefeatures;
    KrollObject* console;
	BOOL shutdown;
