...
// in simulator we redefine to format for nativeFeatures Developer console
...
{\
	NSString * exceptionName = [@"org.nativefeatures." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nativefeatures";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UInativeFeaturesNativeItemNone = -1, 
	UInativeFeaturesNativeItemSpinner = -2,
	UInativeFeaturesNativeItemProgressBar = -3,
	
	UInativeFeaturesNativeItemSlider = -4,
	UInativeFeaturesNativeItemSwitch = -5,
	UInativeFeaturesNativeItemMultiButton = -6,
	UInativeFeaturesNativeItemSegmented = -7,
	
	UInativeFeaturesNativeItemTextView = -8,
	UInativeFeaturesNativeItemTextField = -9,
	UInativeFeaturesNativeItemSearchBar = -10,
	
	UInativeFeaturesNativeItemPicker = -11,
	UInativeFeaturesNativeItemDatePicker = -12,
	
	UInativeFeaturesNativeItemInfoLight = -13,
	UInativeFeaturesNativeItemInfoDark = -14,
	
	UInativeFeaturesNativeItemDisclosure = -15,
	
	UInativeFeaturesNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all nativeFeatures instances of
