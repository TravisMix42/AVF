...
/**
 Base class for all nativeFeatures views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the nativeFeatures view hierarchy (such as wrapped iOS UIViews) was touched.
